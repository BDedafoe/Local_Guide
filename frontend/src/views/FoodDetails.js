...
function FoodDetails() {
	...
	function editFood() {
		navigate(`/foods/${place.placeId}/edit`)
	}

	async function deleteFood() {
		await fetch(`http://localhost:4000/foods/${place.placeId}`, {
			method: 'DELETE'
		})
		navigate('foods')
	}
	...
	async function deleteComment(deletedComment) {
		await fetch(`http://localhost:4000/foods/${place.placeId}/comments/${deletedComment.commentId}`, {
			method: 'DELETE'
		})
	...
	async function createComment(commentAttributes) {
		const response = await fetch(`http://localhost:4000/foods/${place.placeId}/comments`, {
			method: 'POST',
			headers: {
